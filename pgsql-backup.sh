...
# Password
# silahkan buat file $HOME/.pgpass  dengan format berikut
#localhost:5432:*:postgres:passwordanda 
# Host name atau ip server postgres e.g localhost
DBHOST=localhost
...
BACKUPDIR="/var/www/html/backupsql/postgresql"
...
# Email anda , untuk mengirimkan log
MAILADDR="email@root"
